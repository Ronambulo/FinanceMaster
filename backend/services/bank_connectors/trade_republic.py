...
# Required columns that uniquely identify a Trade Republic CSV
TR_REQUIRED = {"datetime", "account_type", "asset_class"}
...
class TradeRepublicConnector(BankConnector):
    """Parser for Trade Republic CSV exports."""

    @classmethod
    def detect(cls, headers: set) -> bool:
        return TR_REQUIRED.issubset(headers)
